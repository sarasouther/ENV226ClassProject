...
documentclass: book
output_dir: "docs"
github-repo: sarasouther/ENV226ClassProject
output:
  bookdown::gitbook:
    css: style.css
    config:
      toc:
        before: |
          <li><a href="./">ENV 226 Class Project: Explorations in Ecology</a></li>
        after: |
          <li><a href="https://github.com/rstudio/bookdown" target="blank">Published with bookdown</a></li>
      edit: https://github.com/sarasouther/ENV226ClassProject/edit/main/%s
      download: ["epub"]
  bookdown::epub_book:
    toc: true
---
...
Download rubrics here:

- [Download the final paper checklist](https://docs.google.com/document/d/1tHPYv7ItUQRhOEq7RtsKchhqs4hU_Iu2/export?format=pdf)
- [Final paper rubric](https://docs.google.com/document/d/13G8SdVpTp7MDJHxx0DN3JzqK4UVE4eHC/export?format=pdf)
- [Presentation rubric](https://drive.google.com/uc?export=download&id=1f5omd8q7F6AxFyLUPQZHya3kfVz5hdI9)
...
Every member of your group will receive the same score on the presentation and will work together on the actual literature review. We will break this project into products due throughout the semester, so that in the end, you will have created a paper roughly 15 pages in length, with Times font, 12 pt, double-spaced, 1-inch margins. Direct language is important in scientific writing, so papers that are somewhat shorter than this will be acceptable. Much shorter, however, indicates an insufficient amount of interpretation, context, or data collection. Please use APA style for citations.
