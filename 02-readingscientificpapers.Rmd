...
By completing this assignment, you will develop critical skills for effectively reading, interpreting, and analyzing scientific articles. Specifically, you will:
...
[Word document to fill out and turn-in](https://drive.google.com/uc?export=download&id=1AYYDivImitN2tWkFxCr64khhpuost5qj)
[Manuscript to review](https://drive.google.com/uc?export=download&id=1KqDECA155h1PtmUjXKTXdqkEd2ArzXK_)
...
- **Literature review**: Authors systematically searched for and analyzed a set of manuscripts to draw novel insights from pre-existing research           studies. Systematic means that authors used particular search terms to identify articles within a particular time period and geographic area. The 
    search can be replicated; in other words, if someone entered the exact search terms and information, they should generate the same body of             literature. All literature returned by the search is reviewed.
- **Meta-analysis**: Similar to a literature review, authors are drawing from previous studies (not conducting an actual experiment), but they use         statistics to look across studies to quantify effects of a factor on a response variable. 
      - Example of a meta-analysis: Researchers looked across studies of forest thinning projects to determine the effect of thinning on the basal area         of trees.
...
Most journals use a conventional *IMRD structure*: An abstract followed by Introduction, Methods, Results, and Discussion. Most article types will use this structure, with the exception of the opinion piece and case studies, which may or may not follow a typical structure.

On the document that you downloaded you will find the questions presented here. Walk through your review of the article answering the questions within the document:

### Review the abstract

1. What type of article are you reading? 
...
3. What are the main findings of this manuscript?
...
Based on the introduction, answer these questions:

4. Why is this study important?



5. What is the question the authors asked?


6. Do the major findings support this question?



7. Are there any terms that you don’t know? List them below and define them.

### Skim the methods. 

The Methods section tells the reader what experiments were done to answer the question stated in the Introduction. Methods are often difficult to read, because of technical language and a level of detail sufficient for another trained scientist to repeat the experiments. However, there are a few things to look for, in order to identify any drawbacks of the study. **Choose your own adventure!** In this section, only answer the questions associated with the type of article that you are reading!

#### Primary research articles

If you are reading a **primary research article**, answer these questions:

8.1. If this is a primary research article, is this an observational or experimental study?



8.2. If this is a primary research article, can you identify any experimental artefacts?



8.3. If this is a primary research article, do they have an appropriate control?



8.4. Is the sample size (aka replication) sufficient to answer the question?



#### Literature review or meta-analysis

If you are reading a **literature review** or **meta-analysis**, answer these questions:

8.1. Did the search terms adequately reflect the question the authors are asking?



8.2. Did the authors unnecessary exclude articles?



8.3. Is the sample size (number of articles included) sufficient to answer the question?


#### Opinion piece or case study

If you are reading an opinion piece or case study, please answer these questions:

8.1. What sources of bias are apparent in the article?
...
8.2. Do a quick search for articles with contrary findings. Are there many? What do they find?




8.3. Did the authors represent these contrary findings or viewpoints in their article?
...
9: Did the authors discuss caveats and limitations to the research? What were they and did they align with issues that you identified?


10: What was the take home message?

## Deliverables 

Please turn-in your completed to Canvas.
