...
- Create and share a Zotero group library with their team members (Optional).
- Add references to their shared library and organize them into folders.
	
## Step-by-Step Instructions

Follow this step-by-step process to set up a Zotero account and start managing your citations (Note that software updates may change the specific directions for setting up a Zotero account and connector. If this happens, please search instructions on the web to complete the assignment):
...
4. Set Up a Group Library (Optional):
...
6.	Set up a shared group library in Zotero if you’re working in a group (Optional):
...
Each student should:
	 ...
	 - Set up their Zotero account and installs the tools.
	 - One group member creates the shared library and invites the others (Optional).
	 - If necessary, repeat your search from last time, and export an RIS file (If you don't have your RIS file yet, just find and import a citation)
...
1.	A screenshot of their shared Zotero library showing at least one reference.
